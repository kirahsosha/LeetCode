...
namespace LeetCodeTester.Solutions
{
    public partial class Solution
    {
        ...
        public int MinScore(int n, int[][] roads)
        {
            ...
            //int GetMinRoad(int i)
            //{
            //    int road = int.MaxValue;

            //    foreach (var roads in graph[i])
            //    {
            //        if (roads.Key < i) continue;
            //        else if (roads.Key == n)
            //        {
            //            road = Math.Min(roads.Value, road);
            //        }
            //        else
            //        {
            //            var newRoad = GetMinRoad(roads.Key);
            //            if(newRoad != int.MaxValue)
            //            {
            //                road = Math.Min(Math.Min(roads.Value, newRoad), road);
            //            }
            //        }
            //    }
